...
try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			...
			$stmt = $conn->prepare("SELECT * FROM capsule WHERE CapsuleStatus = 'c' OR CapsuleStatus = 'm';");
...
// Make the table
  echo "<p> Select a capsule that work is completed on or select Update Capsule Status</p>";
	echo "<table>";
	echo "<tr>";
